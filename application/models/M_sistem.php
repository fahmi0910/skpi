...
class M_sistem extends CI_Model
{
    ...
    {
        $this->db->join('prodi', 'identitas_diri.prodi_id = prodi.id');
    ...
    {
        $this->db->join('seminar', 'seminar.id_user = t_user.id');

        return $this;
    }
    public function getPrestasiUser()
    {
        $this->db->join('prestasi', 'prestasi.id_user = t_user.id');
    ...
    {
        $this->db->join('magang', 'magang.id_user = t_user.id');
    ...
    {
        $this->db->join('kepanitiaan', 'kepanitiaan.id_user = t_user.id');

        return $this;
    }
    public function getKaryaIlmiahUser()
    {
        $this->db->join('karya_ilmiah', 'karya_ilmiah.id_user = t_user.id');

        return $this;
    }
    public function getKeahlianUser()
    {
        $this->db->join('keahlian', 'keahlian.id_user = t_user.id');
