    ...
    <div class="mt3">
      <form action="<?= base_url() ?>management_prodi/simpan_data_diri" method="POST">
        <div class="form-group">
          ...
          <textarea name="izin" id="izin" class="form-control"></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="jenis_dan_program" id="jenis_dan_program">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea name="sertifikat_akreditasi" id="sertifikat_akreditasi" class="form-control"></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="lama_studi" id="lama_studi">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="sistem_penilaian" id="sistem_penilaian">
        </div>
        <div class="form-group">
          <label for="jenis_lanjutan">Jenis Program Pendidikan Lanjutan</label>
          <input type="text" class="form-control" name="jenis_lanjutan" id="jenis_lanjutan">
        </div>
