                            ...
                            if($kirim_seminar > 0)
                            {
                                foreach($data_seminar as $b)
                                {
                                        ...
                                        echo '<tr>
                                                    ...
                                                    <td> <a class="btn btn-primary" href ="'.base_url().'C_seminar/edit_s/'.$b->no.'">Edit</a> <button class="btn btn-danger" data-toggle="modal" data-target="#modalSeminar" data-id="'.$b->no.'" class="hapus">Hapus</button></td>
                                                </tr>';
                                        $n++;
                                }
                            }
