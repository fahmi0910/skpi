<div class="container">
	...
	<div class="mt-3">
		<form action="<?php echo base_url(); ?>C_seminar/update_s" method="post" enctype="multipart/form-data">
		<input type="hidden" name="no" value="<?php echo $edit_s['no']; ?>">
		<input type="hidden" name="editbukti" value="<?php echo $edit_s['bukti']; ?>">
